...
## Introduction
SPLASH is an unsupervised and reference-free unifying framework to discover regulated sequence variation through the statistical analysis of k-mer composition in both DNA and RNA sequences. 
...
The first version of [SPLASH](https://github.com/salzman-lab/nomad/) implemented in Python proved its usefulness. Here we provide SPLASH2, a new and improved implementation in C++ and Python (Kokot et al. 2024).
...
Compactors is a new statistical approach to local seed-based assembly. It comes as a part of SPLASH package and was particularly suited to assemble regions divere across across samples (see figure below). However, it can be used as an independent assembler for any seed provided by the user.
...
Roozbeh Dehghannasiri*, Marek Kokot*, Alexander L. Starr, Jamie Maziarz, Tal Gordon, Serena Y. Tan​​, Peter L. Wang, Ayelet Voskoboynik, Sebastian Deorowicz, and Julia Salzman. [sc-SPLASH provides ultra-efficient reference-free discovery in barcoded single-cell sequencing](https://doi.org/10.1101/2024.12.24.630263), bioRxiv (2024)
