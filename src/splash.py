...
group_10X_Visium.add_argument("--cbc_filtering_thr", default=0, type=int, help="how to filter cbcs, if 0 do the same as umi tools, in the oposite case keep cbcs with freq >= <cbc_filtering_thr>")
...
parser.add_argument("--postprocessing_item", action="append", default=[], type=str, help="path to JSON defining postprocessing, may be defined multiple times, will be executed in the order of provided arguments")
parser.add_argument("--exclude_postprocessing_item", action="append", type=str, help="Path to JSON defining postprocessing to exclude from the default or provided postprocessing items")
