...
group_additional_out.add_argument("--satc_merge_dump_format", default="splash", type=str, choices=['splash', 'satc'], help="splash - text format like in nextflow splash, satc - different order of elements per line")
...
group_technical.add_argument("--bin_path", default="bin", type=str, help="path to a directory where satc, satc_dump, satc_merge, sig_anch, kmc, kmc_tools binaries are")
...
for executable_path in [satc, satc_dump, satc_merge, sig_anch, read_selector]:
