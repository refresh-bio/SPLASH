all: satc satc_dump satc_merge sig_anch read_selector download_kmc splash
...
CC 	= g++
CFLAGS	= -fPIC -Wall -O3 -m64 -std=c++17 -mavx -pthread -I $(INCLUDE_DIR) -I $(OPENBLAS_INCLUDE_DIR) -I $(MIMALLOC_INLUCDE_DIR) -fpermissive
...
release: CFLAGS	= -fPIC -Wall -O3 -DNDEBUG -m64 -std=c++17 -mavx -pthread -I $(INCLUDE_DIR) -I $(OPENBLAS_INCLUDE_DIR) -I $(MIMALLOC_INLUCDE_DIR) -fpermissive
release: all

debug: CFLAGS	= -fPIC -Wall -O0 -g -m64 -std=c++17 -mavx -pthread -I $(INCLUDE_DIR) -I $(OPENBLAS_INCLUDE_DIR) -I $(MIMALLOC_INLUCDE_DIR) -fpermissive
debug: all
